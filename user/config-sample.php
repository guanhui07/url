...
define( 'YOURLS_DB_USER', 'url' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'urlcool..' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'url' );
...
define( 'YOURLS_SITE', 'http://url.jsoncool.com' );
...
define( 'YOURLS_COOKIEKEY',  'zg8%)P7b&NI2SywXm(Wyp~CqV7G])Lc]mpJhRYPN');
